...
typedef enum HandleActionSleepMask {
        HANDLE_SLEEP_SUSPEND                = 1U << HANDLE_SUSPEND,
        HANDLE_SLEEP_HIBERNATE              = 1U << HANDLE_HIBERNATE,
        HANDLE_SLEEP_HYBRID_SLEEP           = 1U << HANDLE_HYBRID_SLEEP,
        HANDLE_SLEEP_SUSPEND_THEN_HIBERNATE = 1U << HANDLE_SUSPEND_THEN_HIBERNATE,
} HandleActionSleepMask;

#define HANDLE_ACTION_SLEEP_MASK_DEFAULT (HANDLE_SUSPEND_THEN_HIBERNATE|HANDLE_HIBERNATE|HANDLE_SUSPEND)
